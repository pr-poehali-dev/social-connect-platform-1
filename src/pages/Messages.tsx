          ...
          <div className="max-w-7xl mx-auto">
            {activeTab === 'calls' ? (
              ...
              <div className="grid lg:grid-cols-3 gap-6 relative">
                ...
                {selectedChat && (
                  <div className="fixed inset-0 z-50 bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 lg:relative lg:inset-auto lg:z-auto lg:bg-transparent lg:col-span-2 pt-36 pb-0 lg:pt-0 lg:pb-0">
